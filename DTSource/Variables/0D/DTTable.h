...
{
public:
    enum StorageType {Empty,Double, Float, Int, Short, Character, Date, IndexedText, Text, Table, SingleNumber, SingleText, SingleDate};
...
public:
    ...
    enum ColumnType {OutOfBounds,Empty,Numerical, Date, Text, Table,SingleNumber,SingleDate,SingleText};
