...
public:
    ...
    DTPoint3D operator*(const DTPoint3D &P) const {return DTPoint3D(T11*P.x+T12*P.y+T13*P.z+S1,
                                                                   T21*P.x+T22*P.y+T23*P.z+S2,
                                                                   T31*P.x+T32*P.y+T33*P.z+S3);}
    DTVector3D operator*(const DTVector3D &P) const {return DTVector3D(T11*P.x+T12*P.y+T13*P.z,
                                                                       T21*P.x+T22*P.y+T23*P.z,
                                                                       T31*P.x+T32*P.y+T33*P.z);}
